...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/Alipay"
  ...
  s.author             = { "hahajzy64" => "jiangzeyang@secretlisa.com" }
  # Or just: s.author    = "hahajzy64"
  # s.authors            = { "hahajzy64" => "jiangzeyang@secretlisa.com" }
  # s.social_media_url   = "http://twitter.com/hahajzy64"
